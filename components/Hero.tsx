  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: "0 8px 32px rgba(0,0,0,0.1), 0 0 0 1px rgba(16, 185, 129, 0.05)",
    ...
    >
      ...
      <div>
        ...
        <div className="text-xs font-medium" style={{ color: "var(--brand)" }}>
...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(165deg, #FFFFFF 0%, #F9FAFB 35%, #ECFDF5 75%, #FFFFFF 100%)",
      }}
    >
      ...
      {glowActive && (
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(16,185,129,0.12) 0%, rgba(16,185,129,0.06) 28%, rgba(20,184,166,0.04) 48%, rgba(56,189,248,0.02) 62%, transparent 78%)",
            filter: "blur(44px)",
            willChange: "left, top",
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(20,184,166,0.1) 0%, rgba(16,185,129,0.05) 40%, transparent 68%)",
            filter: "blur(44px)",
          }}
        />
        <div
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 90% 55% at 50% -8%, rgba(16,185,129,0.1) 0%, transparent 58%)",
        }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center gap-3 mt-4 mb-6 justify-center lg:justify-start w-full whitespace-nowrap overflow-visible">
              <span
                ...
                style={{ color: "var(--foreground)", borderColor: "#cbd5e1" }}
              >
            ...
            >
              <Link
                ...
                className="group flex items-center gap-2 px-8 py-3.5 rounded-xl font-bold text-base text-white bg-gradient-to-r from-emerald-500 to-teal-400 hover:from-emerald-600 hover:to-teal-500 transition-all duration-300 hover:scale-105 shadow-[0_4px_24px_rgba(16,185,129,0.3)] hover:shadow-[0_24px_32px_rgba(16,185,129,0.5)]"
              >
                Start Free — 14 Days
            ...
            >
              {stats.map((s) => (
                <div key={s.label} className="text-center lg:text-left">
                  ...
                  <div className="text-xs mt-0.5 font-semibold" style={{ color: "var(--foreground)" }}>
                    {s.label}
                  </div>
                </div>
              ))}
          ...
          >
            ...
            <div
              ...
              style={{ filter: "drop-shadow(0 32px 64px rgba(0,0,0,0.6)) drop-shadow(0 0 40px rgba(16,185,129,0.1))" }}
            >
              {/* Outer phone bezel */}
              <div
              ...
              >
                ...
                <div className="rounded-[33px] overflow-hidden flex flex-col" style={{ backgroundColor: "#0d1b2a" }}>
                  ...
                  <div className="flex justify-center pt-2.5 pb-1 flex-shrink-0" style={{ backgroundColor: "#075e54" }}>
                    <div className="w-16 h-1 rounded-full" style={{ backgroundColor: "rgba(255,255,255,0.2)" }} />
                  </div>

                  {/* WhatsApp style header but with brand color */}
                  <div
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        <motion.span
                          className="w-1.5 h-1.5 rounded-full inline-block bg-emerald-400"
                      ...
                      {chatMessages.slice(0, visibleCount).map((msg, i) => (
                        ...
                        >
                          <div
                            ...
                            style={{
                              backgroundColor: msg.side === "right" ? "#10B981" : "#1e2d3d",
                          ...
                          >
                            ...
                            <div className={`text-[10px] mt-1 flex items-center gap-1 ${msg.side === "right" ? "justify-end" : "justify-start"}`}
                              style={{ color: msg.side === "right" ? "rgba(255,255,255,0.7)" : "#ffffff" }}
                            >
                              {msg.time}
                              {msg.side === "right" && (
    ...
    <div className="pointer-events-none fixed inset-0 z-0" aria-hidden="true">
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(16,185,129,0.08) 0%, rgba(16,185,129,0.04) 38%, rgba(20,184,166,0.02) 58%, transparent 76%)",
          filter: "blur(36px)",
